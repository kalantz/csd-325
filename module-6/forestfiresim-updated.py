...
FIRE = '@'
EMPTY = ' '
WATER = 'W'  # Added Water to the constants
                    ...
                    for ix in range(-1, 2):
                        for iy in range(-1, 2):
                            ...
                            if forest.get((x + ix, y + iy)) == TREE:
                                if forest.get((x + ix, y + iy)) != WATER: # Prevent fire from spreading across water 
